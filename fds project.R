...
library(data.table)
library(reshape2)
movie_data <- read.csv("C:/Users/Sriman Reddy/Downloads/movies.csv/movies.csv",stringsAsFactors=FALSE)
rating_data <- read.csv("C:/Users/Sriman Reddy/Downloads/ratings.csv/ratings.csv")
str(movie_data)
summary(movie_data)
head(movie_data)
summary(rating_data)
...
SearchMatrix <- cbind(movie_data[1:2], genre_mat2[1:nrow(movie_data), ])
head(SearchMatrix)
